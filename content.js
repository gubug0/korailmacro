...
$(".macro_start_btn").click(macro);
$(".macro_stop_btn").click(macrostop);
`;

function injectJs() {
    var scr = document.createElement('script');
    scr.textContent = injectJsStr;
...
if (document.URL.substring(0, dsturl1.length) == dsturl1 ||
	...
	$(document).ready(function() {
		...
		if (localStorage.getItem('macro') == "true") {
			$(".btn_inq").append('<a href="#" class="macro_stop_btn" style="font-size:15px; margin-left:5px;"><img src="' + chrome.extension.getURL('btn_stop.png') + '"></a>');
			
		} else {
			$(".btn_inq").append('<a href="#" class="macro_start_btn" style="font-size:15px; margin-left:5px;"><img src="' + chrome.extension.getURL('btn_start.png') + '"></a>');
		}
